...
temperature= 295 #Kelvin degrees but this value will be changed by processArguments() function.
v          = 0.02  #Angstrom/picoseconds
inputfile  = None
outputfile = None
...
pmfCumulant2=[]
for i in range(length):
    pmfCumulant.append(workAveList[i] - beta*0.5*(workSqrdAveList[i]-workAveSqrdList[i]))
...
#plt.subplot(2,1,1)
#plt.plot(averageExtension, pmfCumulant, 'b-', label='2nd Order', averageExtension, pmfExact, 'k*', label='Exact', linewidth=2)
