...
set file [open "prot_in_wb_6thShell.dat" w]
for {set x 5} {$x < 206} {incr x} {  
    # set sel [atomselect top "protein" frame $x]
    #set sel [atomselect top "protein or (water and noh within 6.5 of alpha) and not (water and noh within 3.5 of alpha)"]
